function [nn_G_t_ST,nn_D_ST,nn_G_ST,fin_output_target,Xtc_train]=GAN_noconditon_style(Xsc_train,Xtc_train,nn_G_t_ST,nn_D_ST,nn_G_ST)
%%%%%%预处理GAN_ST%%%%%%%%%%%%%%%%%%
...
fin_output_target = nn_G_out(nn_G_t_ST, Xsc_train((Num_xs_input_ST-num_ST):Num_xs_input_ST,:));
